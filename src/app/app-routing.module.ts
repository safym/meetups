...
const routes: Routes = [
  ...
  { path: "meetups/create", component: MeetupFormPageComponent, canActivate: [AuthGuard] },
  { path: "meetups/edit/:id", component: MeetupFormPageComponent, canActivate: [AuthGuard] },
